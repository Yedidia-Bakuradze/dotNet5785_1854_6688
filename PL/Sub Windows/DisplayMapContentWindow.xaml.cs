...
public partial class DisplayMapContentWindow : Window
{
    ...
    public DisplayMapContentWindow(TypeOfMap type, BO.TypeOfRange range, IEnumerable<(double, double)> listOfPoints)
    {
