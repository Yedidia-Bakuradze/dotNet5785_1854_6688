...
- [5th Stage: Initialization Of The Presentation Layer (UI)](#5th-stage-presentation-layer-ui)
...
To login into the sysetm as a admin, we've createa a pre-made user with the following credentials - Id: 332461854, Password: yedidiaYY12@!
